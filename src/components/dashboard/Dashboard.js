                        ...
                        <li className="mt-0.5 w-full bg-white">
                            <a className="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                               href="../pages/dashboard.html">
                                ...
                                <span
                                    class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">پروفایل</span>
                            </a>
                        </li>
                        ...
                        <li className="mt-0.5 w-full bg-white">
                            <a className="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                               href="../pages/billing.html">
                                ...
                                <span
                                    class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">اخبار</span>
                            </a>
                        </li>
