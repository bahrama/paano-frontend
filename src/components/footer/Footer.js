const Footer = () =>{
    return(
        <>
        <footer className="bg-luster-2 font-vazir text-white text-lg">
            <div className="px-2 lg:grid lg:grid-cols-3 sm:grid sm:grid-cols-1 pt-8 pb-2">
                ...
                <div className="px-2 sm:pt-5 md:py-4 lg:py-0 ">
                    <h5 className="border-b-2 border-luster-1 ">تماس با اتحادیه</h5>
                    <ul className="py-2">
                        <li> 
                ...
                <div className="">
                    <h5 className="border-b-2 border-luster-1">دسترسی آسان</h5>
